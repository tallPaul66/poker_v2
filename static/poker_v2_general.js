...
function dealer_badge_show(msg) {
    ...
    if ( dlr == "player1"){
        ...
        document.getElementById('player3_dlr_img').src = blank_img;
        document.getElementById('player3_dlr_img').style.width="0px";
        document.getElementById('player3_dlr_img').style.height="0px";
        document.getElementById('player4_dlr_img').src = blank_img;
        document.getElementById('player4_dlr_img').style.width="0px";
        document.getElementById('player4_dlr_img').style.height="0px";
        document.getElementById('player5_dlr_img').src = blank_img;
        document.getElementById('player5_dlr_img').style.width="0px";
